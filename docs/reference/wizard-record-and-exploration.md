...
| `+0x16` | banner: 0 blue, 1 green, 2 purple, 3 red, 4 yellow | game (yellow flag, STORY-032); live RAM + Cartographer: red (Sharee, 3), blue (Jafar, 0), green (Merlin, 1) and yellow (Freya, 4) city dots each sit on their owner's city. Purple not seen |
